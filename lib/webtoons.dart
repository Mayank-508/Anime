...
final List<WebtoonCategory> category = [
  WebtoonCategory(
    title: 'Hello Baby',
    imgUrl: 'assets/images/img.png', // Local asset path
    detail:
  ...
  WebtoonCategory(
    ...
    imgUrl: 'assets/images/img_1.png', // Local asset path
    detail:
  ...
  WebtoonCategory(
    ...
    imgUrl: 'assets/images/img_2.png', // Local asset path
    detail:
  ...
  WebtoonCategory(
    ...
    imgUrl: 'assets/images/img_3.png', // Local asset path
    detail:
  ...
  WebtoonCategory(
    ...
    imgUrl: 'assets/images/img_4.png', // Local asset path
    detail:
  ...
  WebtoonCategory(
    title: 'The Runaway',
    imgUrl: 'assets/images/img_5.png', // Local asset path
    detail:
  ...
  WebtoonCategory(
    ...
    imgUrl: 'assets/images/img_6.png', // Local asset path
    detail:
  ...
  WebtoonCategory(
    ...
    imgUrl: 'assets/images/img_7.png', // Local asset path
    detail:
  ...
  WebtoonCategory(
    ...
    imgUrl: 'assets/images/img_8.png', // Local asset path
    detail:
  ...
  WebtoonCategory(
    title: 'Romance 101',
    imgUrl: 'assets/images/img_9.png', // Local asset path
    detail:
